...
#include <memory>
#include "../../../client/QuestionManager.h"
...
QT_MOC_LITERAL(3, 27, 5), // "onAdd"
QT_MOC_LITERAL(4, 33, 6), // "onEdit"
QT_MOC_LITERAL(5, 40, 8), // "onDelete"
QT_MOC_LITERAL(6, 49, 8), // "onSearch"
QT_MOC_LITERAL(7, 58, 17), // "onCategoryChanged"
QT_MOC_LITERAL(8, 76, 5) // "index"

    },
    "QuestionManager\0onRefresh\0\0onAdd\0"
    "onEdit\0onDelete\0onSearch\0onCategoryChanged\0"
    "index"
};
...
void QuestionManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->onCategoryChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject QuestionManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_QuestionManager.data,
    qt_meta_data_QuestionManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
