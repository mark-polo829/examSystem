...
QT_MOC_LITERAL(1, 11, 12), // "examFinished"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 15), // "logoutRequested"
QT_MOC_LITERAL(4, 41, 18), // "onQuestionSelected"
QT_MOC_LITERAL(5, 60, 5), // "index"
QT_MOC_LITERAL(6, 66, 13), // "onPrevClicked"
QT_MOC_LITERAL(7, 80, 13), // "onNextClicked"
QT_MOC_LITERAL(8, 94, 15), // "onSubmitClicked"
QT_MOC_LITERAL(9, 110, 9), // "onTimeOut"
QT_MOC_LITERAL(10, 120, 15), // "onAnswerChanged"
QT_MOC_LITERAL(11, 136, 10), // "questionId"
QT_MOC_LITERAL(12, 147, 6), // "answer"
QT_MOC_LITERAL(13, 154, 11), // "updateTimer"
QT_MOC_LITERAL(14, 166, 8) // "onLogout"

    },
    "ExamWindow\0examFinished\0\0logoutRequested\0"
    "onQuestionSelected\0index\0onPrevClicked\0"
    "onNextClicked\0onSubmitClicked\0onTimeOut\0"
    "onAnswerChanged\0questionId\0answer\0"
    "updateTimer\0onLogout"
};
...
void ExamWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->examFinished(); break;
        case 1: _t->logoutRequested(); break;
        case 2: _t->onQuestionSelected((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->onPrevClicked(); break;
        case 4: _t->onNextClicked(); break;
        case 5: _t->onSubmitClicked(); break;
        case 6: _t->onTimeOut(); break;
        case 7: _t->onAnswerChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ExamWindow::examFinished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ExamWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ExamWindow::logoutRequested)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void ExamWindow::logoutRequested()
{
