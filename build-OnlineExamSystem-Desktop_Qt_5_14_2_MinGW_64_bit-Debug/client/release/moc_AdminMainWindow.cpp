...
#include <memory>
#include "../../../client/AdminMainWindow.h"
...
QT_MOC_LITERAL(1, 16, 15), // "logoutRequested"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 14), // "onMenuSelected"
QT_MOC_LITERAL(4, 48, 5), // "index"
QT_MOC_LITERAL(5, 54, 8) // "onLogout"

    },
    "AdminMainWindow\0logoutRequested\0\0"
    "onMenuSelected\0index\0onLogout"
};
...
void AdminMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onMenuSelected((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (AdminMainWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AdminMainWindow::logoutRequested)) {
                *result = 0;
                return;
            }
        }
