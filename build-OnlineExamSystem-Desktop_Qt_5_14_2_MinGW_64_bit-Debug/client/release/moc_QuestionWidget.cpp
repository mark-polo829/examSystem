...
#include <memory>
#include "../../../client/QuestionWidget.h"
...
QT_MOC_LITERAL(1, 15, 13), // "answerChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 10), // "questionId"
QT_MOC_LITERAL(4, 41, 6), // "answer"
QT_MOC_LITERAL(5, 48, 21), // "onSingleChoiceChanged"
QT_MOC_LITERAL(6, 70, 2), // "id"
QT_MOC_LITERAL(7, 73, 23), // "onMultipleChoiceChanged"
QT_MOC_LITERAL(8, 97, 18) // "onTrueFalseChanged"

    },
    "QuestionWidget\0answerChanged\0\0questionId\0"
    "answer\0onSingleChoiceChanged\0id\0"
    "onMultipleChoiceChanged\0onTrueFalseChanged"
};
...
void QuestionWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->answerChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 1: _t->onSingleChoiceChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->onMultipleChoiceChanged(); break;
        case 3: _t->onTrueFalseChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QuestionWidget::*)(int , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QuestionWidget::answerChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void QuestionWidget::answerChanged(int _t1, const QString & _t2)
{
