...
QT_MOC_LITERAL(6, 56, 15), // "onReplyFinished"
QT_MOC_LITERAL(7, 72, 14), // "QNetworkReply*"
QT_MOC_LITERAL(8, 87, 5) // "reply"

    },
    "HttpClient\0requestFinished\0\0response\0"
    "requestError\0error\0onReplyFinished\0"
...
void HttpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->requestFinished((*reinterpret_cast< const QJsonObject(*)>(_a[1]))); break;
...
// SIGNAL 0
void HttpClient::requestFinished(const QJsonObject & _t1)
{
